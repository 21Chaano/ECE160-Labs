...
our_list = my_list + your_list # Just like with strings, you can use "+" to concatenate/merge lists
print(our_list)
...
our_list[our_list.index(my_flower2)] = their_flower # The index method will return the index in the list of whatever is in the parentheses
print(our_list)

# 6. TODO: Remove the first occurrence of their_flower from
# our_list without using index()
our_list.remove(their_flower) # The remove method will do exactly what this part asks
print(our_list)

# 7. TODO: Remove the second element of our_list
our_list.remove(our_list[1]) # remember that indexing starts from 0.
print(our_list)
